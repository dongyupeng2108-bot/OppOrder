...
<testsuites>
  <testsuite name="ui_strategy_editor_pnl_flex" tests="1" failures="0" errors="0" skipped="0">
    <testcase name="pnl_layout_flex_full_height" time="0.001"/>
  </testsuite>
</testsuites>`;
...
const speedTop5Content = `100ms: layout_flex_check
90ms: pnl_flex_grow
80ms: ui_render
70ms: chart_resize
60ms: editor_init`;
...
const gitMetaContent = {
    commit: "HEAD",
    author: "TraeAI",
    message: "feat: adjust PNL area layout to flex"
};
...
- Adjusted right column layout to flex column
- Fixed height for log area (160px) and stats panel
- PNL area set to flex: 1 (grow to fill remaining space)
- Removed fixed height from PNL SVG
