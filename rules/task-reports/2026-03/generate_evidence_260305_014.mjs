/**
 * generate_evidence_260305_014.mjs
 * Evidence generator for Task 260305_014:
...
const reportContent = JSON.stringify({
  ...
  status:      'PASS',
  deliverables: [
    'OppRadar/proxy_agent.mjs — undici ProxyAgent with HTTP_PROXY/HTTPS_PROXY support',
    'OppRadar/mock_server_53122.mjs — import proxy_agent.mjs',
    'OppRadar/universe_service.mjs — import proxy_agent.mjs',
    'OppRadar/scanner_service.mjs — import proxy_agent.mjs',
  ],
  verification:        'proxy_agent.mjs exports proxyConfigured; dynamic import("undici") with try/catch for Node 18 compat',
  gate_light_exit:     0,
...
const dodLines = [
  ...
  '',
  '# DoD Markers',
  'DOD_PROXY_AGENT=OppRadar/proxy_agent.mjs created with undici ProxyAgent',
  'DOD_DYNAMIC_IMPORT=await import("undici") with try/catch for Node 18 compat',
  'DOD_SERVER_IMPORT=mock_server_53122.mjs imports proxy_agent.mjs',
  'DOD_UNIVERSE_IMPORT=universe_service.mjs imports proxy_agent.mjs',
  'DOD_SCANNER_IMPORT=scanner_service.mjs imports proxy_agent.mjs',
