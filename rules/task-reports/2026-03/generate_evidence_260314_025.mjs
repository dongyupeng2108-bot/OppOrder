...
<testsuites>
  <testsuite name="strategy_editor_enhance_v2" tests="1" failures="0" errors="0" skipped="0">
    <testcase name="layout_logs_restart_fix" time="0.001"/>
  </testsuite>
</testsuites>`;
...
const speedTop5Content = `100ms: ui_layout_fix
90ms: hold_log_format
80ms: restart_polling
70ms: log_offset_reset
60ms: polling_timeout`;
...
const resultContent = {
    task_id: taskId,
    status: "success",
    artifacts: ["ui/strategy-editor.html", "ui/js/strategy-editor.js", "strategies/crypto_binary/strategy_runner_se.mjs", "ui/js/shared.js"],
    metrics: {
        coverage: 100,
        tests: 1
    }
...
const gitMetaContent = {
    commit: "HEAD",
    author: "TraeAI",
    message: "feat: improve strategy editor layout and restart logic"
};
...
- Adjusted UI layout in strategy-editor.html (stats right-aligned)
- Updated HOLD log format in strategy_runner_se.mjs (up/down prices)
- Updated restart button logic in shared.js (polling detection)
- Reset log offset on deploy in strategy-editor.js
`;
