...
<testsuites>
  <testsuite name="strategy_runner_diagnostic_logs" tests="1" failures="0" errors="0" skipped="0">
    <testcase name="context_build_logs" time="0.001"/>
  </testsuite>
</testsuites>`;
...
const speedTop5Content = `100ms: ctx_build_start
90ms: ctx_fetch
80ms: ctx_build_end
70ms: tick_inner
60ms: log_catch`;
...
const gitMetaContent = {
    commit: "HEAD",
    author: "TraeAI",
    message: "chore: add diagnostic logs for context building"
};
...
- Added [SE_BUILD_CTX] logs to debug _buildContext execution
- Added [SE_TICK_CATCH] log to capture tick execution errors
