/**
 * run_eval_deepseek_scan.mjs
 * Evaluation runner: runs 25 evaluation set markets through DeepSeek Reasoner
 * Profile: SCAN (temperature=0, max_tokens=1000)
 * Serial execution, 1s interval between calls.
 *
 * Usage: HTTPS_PROXY=http://127.0.0.1:51081 node scripts/run_eval_deepseek_scan.mjs
 */
...
const OUT_FILE = 'data/evaluation_run_20260304_deepseek_scan.json';

const PROFILE = {
  name: 'SCAN',
  temperature: 0,
  max_tokens: 4096,  // DeepSeek Reasoner: reasoning+content share this budget; 1000 is insufficient
};
