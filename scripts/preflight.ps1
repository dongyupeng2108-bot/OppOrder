...
$IgnoredPatterns = @("workspace_healer_$TaskId.json", "preflight_attestation_$TaskId.json", "notify_$TaskId.txt", "result_$TaskId.json", "run_$TaskId.log", ".budget_$TaskId.json", "rules/task-reports/runs/$TaskId/")
