...
const reportsDir = path.join(rulesDir, 'task-reports', '2026-02');
...
<testsuites>
  <testsuite name="dummy" tests="1" failures="0" errors="0" skipped="0">
    <testcase name="dummy_test" time="0.001"/>
  </testsuite>
</testsuites>`;
...
const speedTop5Content = `100ms: dummy_test_1
90ms: dummy_test_2
80ms: dummy_test_3
70ms: dummy_test_4
60ms: dummy_test_5`;
