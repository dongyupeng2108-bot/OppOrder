...
const DEFAULT_TASK_ID = '260406_019';
const DEFAULT_BASE_URL = 'http://localhost:53123';

const parseArgs = () => parseVerifyArgs({
  defaultTaskId: DEFAULT_TASK_ID,
  defaultBaseUrl: DEFAULT_BASE_URL,
  defaultOutputSuffix: 'truth_audit_business_regression_pack_v2_260406_019',
  defaultSampleName: 'business_regression_pack_v2'
});
...
const main = async () => {
  ...
  const requiredTruthAudits = [
    ...
    '260406_014_truth_audit_runner_tick_observability_260406_014.json',
    '260406_015_truth_audit_runner_last_summary_260406_015.json',
    '260406_016_truth_audit_doc_contract_runner_summary_260406_016.json',
    '260406_017_truth_audit_runner_summary_version_260406_017.json',
    '260406_018_truth_audit_bot_logs_filters_260406_018.json'
  ];
  ...
  const checks = {
    ...
    contract_doc_declares_last_summary_endpoint: /GET \/bot\/runner\/last-summary/.test(contractDoc),
    contract_doc_declares_logs_filters: /event/.test(contractDoc) && /window_id/.test(contractDoc),
    latest_points_to_260406_019: latest?.task_id === args.taskId,
  ...
  const firstBreakLayer = pass ? 'NONE_CHAIN_PASS' : 'business_regression_pack_v2';
  const standard = buildStandardResult({
    scriptName: 'truth_audit_business_regression_pack_v2_260406_019',
    taskId: args.taskId,
    ...
    rawExcerpt: {
      fail_to_pass: {
        before: 'regression_pack_v2_not_built',
        after: pass ? 'regression_pack_v2_built' : 'regression_pack_v2_incomplete'
      },
