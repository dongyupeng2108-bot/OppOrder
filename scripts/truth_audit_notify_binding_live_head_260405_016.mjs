...
const DEFAULT_TASK_ID = '260405_016';
const DEFAULT_BASE_URL = 'http://localhost:53123';

const parseArgs = () => parseVerifyArgs({
  defaultTaskId: DEFAULT_TASK_ID,
  defaultBaseUrl: DEFAULT_BASE_URL,
  defaultOutputSuffix: 'truth_audit_notify_binding_live_head_260405_016',
...
const main = async () => {
  ...
  const standard = buildStandardResult({
    scriptName: 'truth_audit_notify_binding_live_head_260405_016',
    taskId: args.taskId,
